...
跨平台、离线优先的 Markdown 实时预览编辑器原型，基于 Tauri 2 + React + Vite 搭建。目标：高性能大文件编辑、可视化（KaTeX / Mermaid / PlantUML / XMind）、标签页、多格式导出、主题与插件体系。
...
- 离线渲染安全隔离（PlantUML/XMind 本地化），主题/快捷键/插件系统。
- 大文件性能优化与多标签页体验。
